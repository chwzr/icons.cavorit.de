...
const icons1 = importIcons(
  require.context(`@chwzr/cavoricons/24/outline/`, false, /\.svg$/),
  'class="w-6 h-6"'
)
const icons2 = importIcons(
  require.context(`@chwzr/cavoricons/24/solid/`, false, /\.svg$/),
  'class="w-6 h-6"'
)
const icons3 = importIcons(
  require.context(`@chwzr/cavoricons/20/solid/`, false, /\.svg$/),
  'class="w-5 h-5"'
)

function Logo(props) {
  return (
    <div className='text-3xl font-bold text-blue-500'>Cavoricons</div>
        ...
        <div className="flex justify-center text-center lg:pt-5 lg:pb-7 lg:text-left">
          <div className="flex max-w-[37rem] flex-col py-16 lg:pt-12 lg:pb-11">
            <h1 className="mt-6 text-[1.75rem] font-extrabold leading-9 tracking-tight text-slate-900 md:text-4xl">
              Beautiful hand-crafted SVG icons, by the makers of DATACARDS.
            </h1>
